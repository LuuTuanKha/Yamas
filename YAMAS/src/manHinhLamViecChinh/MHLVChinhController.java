...
//	private ObservableList<String> listGiaThanh = FXCollections.observableArrayList("Tất cả","Đen","Trắng","Xám","Đỏ","Vàng","Xanh lá cây","Xanh Dương","Xanh Aqua");
	...
	TreeItem<String> tree_QLHD = new TreeItem<>(" 1. Quản lý hoá đơn");
	...
	TreeItem<String> tree_QLKH = new TreeItem<>(" 2. Quản lý khách hàng");
	TreeItem<String> tree_QLSP = new TreeItem<>(" 3. Quản lý sản phẩm");
...
//			}
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		// vboxListView.getChildren().add(tree);
		tree.setRoot(root);
		// tree.getStyleClass().add("tree");
		tree.getSelectionModel().select(0);

//		TreeItem<String> selectedItem2 = tree.getSelectionModel().getSelectedItem();
//		TreeItem<String> x = tree.getSelectionModel().getSelectedItem().getParent().nextSibling();
//		//tree.getSelectionModel().select(selectedItem2);

		// TreeItem<String> s = tree.getSelectionModel().getSelectedItems().;
		// tree.getSelectionModel().g
		// ChuyenChucNang2();
